...
async function main(){
  ...
  check('DOI matches the identifier supplied by the maintainer',document.querySelector('meta[name="citation_doi"]')?.getAttribute('content')==='10.5281/zenodo.22682135');
